...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!-- subsection -->
    <xsl:template match="/state/section/subsection">
    ...
    <!-- subsectionparagraph -->
    <xsl:template match="/state/section/subsection/subsectionparagraph">
        <p>
            <!-- paragraph fields -->
            <xsl:apply-templates />
        </p>
    ...
    <!-- field -->
    <xsl:template match="/state/section/subsection/subsectionparagraph/field">
        <!-- subject -->
        <strong>
