            ...
            <fo:page-sequence master-reference="states">
                ...
                <fo:static-content flow-name="xsl-region-before">
                    <fo:block text-align="center" margin-top="15pt">
                        ...
                        <xsl:value-of select="data/author/fullname" />
                        <!-- email -->
                        <xsl:text>, email: </xsl:text>
                        <xsl:value-of select="data/author/email" />
                    </fo:block>
                </fo:static-content>
                ...
                <fo:flow flow-name="only_region">
                    <!-- heading -->
                    <fo:block text-align="center" font-size="40pt" margin-bottom="0.5in" margin-top="2in" color="tomato">
                        <xsl:text>The world fact book</xsl:text>
                    </fo:block>

                    <!-- table of contents of document/navigation links -->
                    <fo:block font-size="25pt" text-align="center" margin-bottom="5pt" margin-top="40pt">
                        Table of contents:
                    </fo:block>
                    <fo:block break-after="page">
                        <xsl:for-each select="data/states/state">
                            <fo:block text-align="center" text-transform="capitalize" font-size="20pt">
                                <!-- link to state -->
                                <fo:basic-link color="blue" margin-bottom="9pt" text-decoration="underline">
                    ...
                    <xsl:for-each select="data/states/state">
                        ...
                        <!-- each state starts on new page -->
                        <fo:block break-after="page">
                            <!-- state name -->
                            <fo:block font-size="36pt" font-weight="bold" margin-bottom="12pt" text-transform="capitalize" color="tomato">
                                <!-- id -->
                            ...
                            <!-- table of contents of sections/navigation -->
                            <fo:block margin-bottom="20pt">
                                <fo:block font-size="24pt" margin-bottom="7pt" font-weight="600" color="tomato">
                                    <xsl:text>Sections:</xsl:text>
                                </fo:block>
                                <xsl:for-each select="section">
                                    <fo:block margin-bottom="5pt">
                                        <xsl:number count="section" format="1. " />
                                        <fo:basic-link color="blue" margin-bottom="5pt" font-size="15pt" text-decoration="underline">
                                            <xsl:attribute name="internal-destination">
                                                <xsl:copy-of select="$state-name" />
                            ...
                            <xsl:for-each select="section">
                                <fo:block margin-bottom="10pt">
                                    <!-- section name -->
                                    <fo:block font-size="24pt" margin-bottom="7pt" text-transform="capitalize" font-weight="bold" color="tomato">
                                        <xsl:attribute name="id">
                                            <xsl:copy-of select="$state-name" />
                                            <xsl:value-of select="@heading" />
                                        </xsl:attribute>
